...
public:
    ...
    {
        return database.end();    ///< End of split points
    }
    iterator begin(void)
    {
        return database.begin();    ///< Beginning of split points
    ...
    {
        return database.lower_bound(pnt);    ///< Get first split point after given point
    }
    ...
    void clear(void)
    {
        database.clear();    ///< Clear all split points
    }
    bool empty(void) const
    {
        return database.empty();    ///< Return \b true if there are no split points
    }
};
