...
public:
    ...
    {
        elementname = el;    ///< Construct from element name string
    }
    ~Attributes(void)
    {
    ...
    {
        return bogus_uri;    ///< Get the namespace URI associated with this element
    }
    ...
    {
        return name.size();    ///< Get the number of attributes associated with the element
    }
    const string &getURI(int4 i) const
    {
        return bogus_uri;    ///< Get the namespace URI associated with the i-th attribute
    }
    const string &getLocalName(int4 i) const
    {
        return *name[i];    ///< Get the local name of the i-th attribute
    }
    const string &getQName(int4 i) const
    {
        return *name[i];    ///< Get the qualified name of the i-th attribute
    }
    ...
    {
        return *value[i];    ///< Get the value of the i-th attribute
    }
...
public:
    Element(Element *par)
    {
        parent = par;    ///< Constructor given a parent Element
    }
    ~Element(void);				///< Destructor
    void setName(const string &nm)
    {
        name = nm;    ///< Set the local name of the element
    }
    ...
    {
        return parent;    ///< Get the parent Element
    }
    const string &getName(void) const
    {
        return name;    ///< Get the local name of \b this element
    }
    const List &getChildren(void) const
    {
        return children;    ///< Get the list of child elements
    }
    const string &getContent(void) const
    {
        return content;    ///< Get the character content of \b this element
    }
    ...
    {
        return attr.size();    ///< Get the number of attributes for \b this element
    }
    const string &getAttributeName(int4 i) const
    {
        return attr[i];    ///< Get the name of the i-th attribute
    }
...
public:
    ...
    {
        return *children.begin();    ///< Get the root Element of the document
    }
};
...
public:
    ...
    {
        root = rt;    ///< Constructor given root Element
        cur = root;
    }
    ...
    {
        return error;    ///< Get the current error message
    }
};
