...
public:
    ValueSymbol(void)
    {
        patval = (PatternValue *)0;    // For use with restoreXml
    }
...
public:
    StartSymbol(void)
    {
        patexp = (PatternExpression *)0;    // For use with restoreXml
    }
...
public:
    SubtableSymbol(void)
    {
        pattern = (TokenPattern *)0;    // For use with restoreXml
