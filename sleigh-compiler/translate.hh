...
public:
    ...
    {
        return spaceName;    ///< Get name of address space being truncated
    }
    uint4 getSize(void) const
    {
        return size;    ///< Size (of pointers) for new truncated space
    }
};
...
public:
    ...
    {
        return contain;    ///< Return containing space
    }
...
public:
    ...
    {
        return pieces.size();    ///< Get number of pieces in this record
    }
    bool isFloatExtension(void) const
    {
        return (pieces.size() == 1);    ///< Does this record extend a float varnode
    }
    const VarnodeData &getPiece(int4 i) const
    {
        return pieces[i];    ///< Get the i-th piece
    }
