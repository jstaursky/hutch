...
public:
    ...
    {
        return mask;    ///< Return the mask for \b this value
    }
    int4 getWord(void) const
    {
        return word;    ///< Return the word index for \b this value
    }
...
public:
    ...
    {
        return database;    ///< Retrieve the encapsulated database object
    }
