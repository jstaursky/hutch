...
int main (int argc, char* argv[])
{
    ...
    string sleighfilename = "../../processors/8085/languages/8085.sla";
    Sleigh trans (&loader, &context);


    // Inspecting the specfile 8085.slaspec reveals that has no '#Define context
    // ...' lines in it. Therefore there is no need to add any context beyond
    // what is set above.
